...
object TrustWalkers_v1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Calculate RMSE error between the estimated and the real rating
  ...
  //Function for compute the cosine similarity between two vector
  ...
  //Function for calculate the probability to stop at a given node in function of k
  def fK(k:Int):Double={
